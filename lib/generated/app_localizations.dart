...
abstract class AppLocalizations {
  ...
  /// Texto do cabeçalho de acesso à conta
  ///
  ...
  /// Texto do botão de esqueci minha senha
  ///
  /// In pt, this message translates to:
  /// **'Esqueci minha senha'**
  String get forgotPassword;

  /// Texto do botão de criar minha conta
  ///
  /// In pt, this message translates to:
  /// **'Criar minha conta'**
  String get createAccount;

  /// Texto que indica a versão do aplicativo
  ///
  /// In pt, this message translates to:
  /// **'Versão:'**
  String get version;

  /// Mensagem de erro ao autenticar
  ///
  /// In pt, this message translates to:
  /// **'E-mail ou senha inválidos'**
  String get invalidCredentials;

  /// Mensagem de validação para campos obrigatórios
  ///
  /// In pt, this message translates to:
  /// **'Campo obrigatório'**
  String get requiredField;

  /// Mensagem de validação para email inválido
  ///
  /// In pt, this message translates to:
  /// **'Email inválido'**
